...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr made it so easy to keep track of our group trip expenses. No more awkward reminders or spreadsheets — everything just balances out automatically.",
    name: "David Beckham",
  ...
  {
    quote:
      "I use Splitr every month with my flatmates. It's super simple to log bills and see who owes what. The UI is clean and everything just works.",
    name: "Joseph Christopher",
    image: "/testimonials/Joseph.png",
    role: "Software Engineer",
  },
  {
    quote:
      "As a freelance photographer, I often travel with clients and teams. Splitr helps us stay on top of shared costs without wasting time doing math.",
    name: "Usman Rao",
    image: "/testimonials/Usman.png",
